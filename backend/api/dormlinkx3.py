...
class DormRecommenderX3:
    ...
    def get_cbf_recommendations(self, student_id):
        ...
        filtered = self.dorms_df[
            ...
            ((self.dorms_df["gender_policy"].str.lower() == "mixed") | (self.dorms_df["gender_policy"].str.lower() == student["gender"].lower()))
        ]
    ...
    def recommend_hybrid(self, student_id, k=5):
        ...
        for dorm in all_dorms:
            ...
            # Applying the new formula from dormlinkx3
            final_scores[dorm] = (w_cbf * s_cbf) + (w_cf * s_cf)
            
        ranked = sorted(final_scores.items(), key=lambda x: x[1], reverse=True)
        return [d[0] for d in ranked[:k]]

recommender_instance = DormRecommenderX3()
